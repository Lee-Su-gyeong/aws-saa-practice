  ...
  return (
    <div className="space-y-6 pt-2">
      <div>
        ...
        <h1 className="text-2xl font-bold text-orange-500 mt-1">기출 문제</h1>
        <p className="text-gray-500 dark:text-gray-400 text-sm mt-1">세트를 선택해 풀기 시작하세요</p>
      </div>
      ...
      <div className="grid gap-3">
        {sets.map(s => (
          ...
          >
            <div>
              <h2 className="font-semibold text-gray-900 dark:text-gray-100 group-hover:text-orange-600 dark:group-hover:text-orange-300 transition-colors">
                {s.exam_set}
              </h2>
              <p className="text-sm text-gray-500 dark:text-gray-400 mt-0.5">{s.count}문제</p>
            </div>
            <span className="text-gray-300 dark:text-gray-600 group-hover:text-orange-400 transition-colors text-sm">→</span>
          </a>
        ))}
      </div>
    </div>
